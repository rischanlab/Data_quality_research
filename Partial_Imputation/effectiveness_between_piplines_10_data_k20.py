...
if __name__ == "__main__":
    ...
    for k in k_list:
        ...
        for percent in percentage_list:
            for i in range(10):
                file_name0 = '10_percent_missing_m_3k_20k/db_' +str(percent) + 'diab' + str(i+1) + '.xlsx'
                ...
                for impute_file in glob.glob(file_name0):
                    ...
                    if len(impute_file) == 43:
                        standard_file = '10_percent_missing_m_3k_20k/standard_' + impute_file[-15:]
                        print(standard_file)
                    else:
                        standard_file = '10_percent_missing_m_3k_20k/standard_' + impute_file[-16:]
                        print(standard_file)
                    ...
                    with open('results/dynamic_vs_standard_10_data_20k.csv', 'a', newline='') as f:
