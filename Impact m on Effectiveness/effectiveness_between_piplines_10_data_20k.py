...
if __name__ == "__main__":
    ...
    for my in my_list:
        ...
        for percent in percentage_list:
            for i in range(10):
                file_name0 = '20k_m_' + str(my) + 'k/db_' +str(percent) + 'diab' + str(i+1) + '.xlsx'
                ...
                for impute_file in glob.glob(file_name0):
                    ...
                    if len(impute_file) == 24:
                        standard_file = '20k_m_' + str(my) + 'k/standard_' + impute_file[-15:]
                        #print(standard_file)
                    else:
                        standard_file = '20k_m_' + str(my) + 'k/standard_' + impute_file[-16:]
                        #print(standard_file)
