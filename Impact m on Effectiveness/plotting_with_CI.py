...
input_file_dynamic_vs_ideal = 'results/dynamic_vs_ideal_10_data.csv'
input_file_dynamic_vs_standard = 'results/dynamic_vs_standard_10_data.csv'


output_plot_dynamic_vs_ideal = 'dynamic_vs_ideal_10'
output_plot_dynamic_vs_standard = 'dynamic_vs_standard_10'
...
ax.plot(mean0, lw = 1, color = '#539caf', alpha = 1, label = 'Jaccard', marker='o', linestyle='dashed', linewidth=2, markersize=12)
ax.plot(mean1, lw = 1, color = '#b65332', alpha = 1, label = 'RBO 0.95', marker='s', linestyle=':', linewidth=2, markersize=12)
...
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Dynamic to Ideal")
x = [5, 10, 15, 20]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
...
plt.savefig('plot/' + output_plot_dynamic_vs_ideal, format="svg", dpi = 1000)
plt.savefig('plot/' + output_plot_dynamic_vs_ideal + '.png')
plt.show()
...
df = pd.read_csv(input_file_dynamic_vs_standard, names=['percentage','k','RBO','Jaccard'])
...
ax.set_title("Impact of k on Effectiveness - 95% CI, m = 3k, 10 % missing")
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Dynamic to Standard")
x = [5, 10, 15, 20]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
...
plt.savefig('plot/' + output_plot_dynamic_vs_standard, format="svg", dpi = 1000)
plt.savefig('plot/' + output_plot_dynamic_vs_standard + '.png')
plt.show()
