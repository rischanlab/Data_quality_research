...
output_plot = 'all_percentage_Jaccard_compare_three_missing_to_ideal'
...
#ax.plot(mean5, lw = 1, color = '#5be19a', alpha = 1, label = 'RBO 0.95 Selective-imputation to Ideal', marker='x', linestyle='-.', linewidth=2, markersize=12)
