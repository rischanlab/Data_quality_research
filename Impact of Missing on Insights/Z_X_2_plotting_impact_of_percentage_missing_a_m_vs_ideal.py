...
input_file = 'results_new/missing_combine_a_m_vs_ideal.csv'

output_plot = 'all_percentage_missing_combine_a_m_vs_ideal'
...
plt.savefig('plot_new/' + output_plot, format="svg", dpi = 1000)
plt.savefig('plot_new/' + output_plot + '.png')
plt.show()
