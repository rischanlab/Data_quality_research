...
input_file = 'results/standard_vs_ideal.csv'

output_plot_ideal_vs_standard = 'standard_vs_ideal_80'
...
ax.set_title("Impact of k on Effectiveness - 95% CI, 80 % missing + impute")
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Standard to Ideal")
x = [5, 10, 15, 20]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
