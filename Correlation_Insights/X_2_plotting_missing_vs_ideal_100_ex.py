...
input_file = 'results/missing_topk_vs_ideal_100_execution.csv'

output_plot_ideal_vs_standard = 'missing_topk_vs_ideal_100_execution'
...
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Missing topk columns to Ideal")
x = [5, 10, 15, 20]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
...
plt.savefig('plot_100_ex/' + output_plot_ideal_vs_standard, format="svg", dpi = 1000)
plt.savefig('plot_100_ex/' + output_plot_ideal_vs_standard + '.png')
plt.show()
