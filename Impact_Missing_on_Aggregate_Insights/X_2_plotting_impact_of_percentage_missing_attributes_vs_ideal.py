...
#output_plot1 = 'all_percentage_dropnan_attributes_vs_ideal'
output_plot2 = '100_all_percentage_nodrop_attributes_vs_ideal'
...
# ax.set_ylabel("Effectiveness - Missing attributes to Ideal - drop nan rows")
# x = [0, 5, 10, 15]
# xi = list(range(len(x)))
# plt.xticks(xi, x)
# # Display legend
