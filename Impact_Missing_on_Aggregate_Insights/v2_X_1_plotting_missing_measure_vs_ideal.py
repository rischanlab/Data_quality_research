...
input_file1 = 'results/missing_zipf_measures_vs_ideal.csv'
input_file2 = 'results/missing_zipf_op_measures_vs_ideal.csv'

output_plot1 = 'missing_zipf_measures_vs_ideal'
output_plot2 = 'missing_zipf_op_measures_vs_ideal'
...
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Missing Measure to Ideal")
x = [5, 10, 15, 20]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
