...
input_file1 = 'results/missing_zipf_a_m_vs_ideal.csv'
input_file2 = 'results/missing_zipf_op_a_m_vs_ideal.csv'

output_plot1 = 'missing_zipf_a_m_vs_ideal'
output_plot2 = 'missing_zipf_op_a_m_vs_ideal'
