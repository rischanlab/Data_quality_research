...
input_file1 = 'results/variance_readmitted_no_vs_whole_nodrop_a_m.csv'
input_file2 = 'results/variance_insulin_steady_vs_no_steady_nodrop_a_m.csv'

output_plot = 'variance_nodrop_a_m_readmitted_vs_insulin'
...
ax.set_title("Impact of k and missing A & M, 95% CI")
ax.set_xlabel("k")
