...
#input_file1 = 'results/dropnan_a_m_vs_ideal.csv'
input_file2 = 'results/100_nodrop_a_m_vs_ideal.csv'

#output_plot1 = 'all_percentage_dropnan_a_m_vs_ideal'
output_plot2 = '100_all_percentage_nodrop_a_m_vs_ideal'
...
# ax.set_title("Impact of percentage of missing on Effectiveness, CI 95%, k = 5")
# ax.set_xlabel("percentage of missing")
# ax.set_ylabel("Effectiveness - Missing A & M to Ideal - drop nan rows")
# x = [0, 5, 10, 15]
# xi = list(range(len(x)))
# plt.xticks(xi, x)
# # Display legend
