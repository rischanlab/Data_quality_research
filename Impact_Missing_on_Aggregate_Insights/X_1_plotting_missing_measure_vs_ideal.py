...
input_file2 = 'results/100_nodrop_measures_vs_ideal.csv'

#output_plot1 = 'dropnan_measures_vs_ideal'
output_plot2 = '100_nodrop_measures_vs_ideal'
...
# ax.set_title("Impact of k on Effectiveness, 95% CI, 10 % measure missing")
# ax.set_xlabel("k")
# ax.set_ylabel("Effectiveness - Missing Measure to Ideal - drop nan rows")
# x = [5, 10, 15, 20]
# xi = list(range(len(x)))
# plt.xticks(xi, x)
# # Display legend
