...
if __name__ == "__main__":
    ...
    for k in k_list:
        ...
        for i in range(10):
            ...
            file_name = 'raw_results/db_missing_zipf_a_m' + str(i + 1) + '.xlsx'
            for file_view in glob.glob(file_name):
                ...
                with open('results/missing_zipf_a_m_vs_ideal.csv', 'a', newline='') as f:
    ...
    for k in k_list:
        ...
        print("Ideal topk", topk)
        for i in range(10):
            file_name = 'raw_results/db_missing_zipf_op_a_m' + str(i+1) + '.xlsx'
            ...
            for file_view in glob.glob(file_name):
                ...
                print("RBO Standard to Ideal = {}".format(ag.rboresult(missing, topk)))
                print("Jaccard Standard to Ideal = {}".format(ag.jaccard_similarity(missing, topk)))
                with open('results/missing_zipf_op_a_m_vs_ideal.csv', 'a', newline='') as f:
