...
input_file1 = 'results/missing_zipf_attributes_vs_ideal.csv'
input_file2 = 'results/missing_zipf_op_attributes_vs_ideal.csv'

output_plot1 = 'missing_zipf_attributes_vs_ideal'
output_plot2 = 'missing_zipf_op_attributes_vs_ideal'

# ===============================================================
# IDEAL VS STANDARD

df = pd.read_csv(input_file1, names=['k','RBO','Jaccard'])
...
ax.set_title("Impact of k on Effectiveness, 95% CI - Zipf missing")
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Missing Attribute to Ideal")
x = [5, 10, 15, 20]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
...
df = pd.read_csv(input_file2, names=['k','RBO','Jaccard'])
...
# Label the axes and provide a title
ax.set_title("Impact of k on Effectiveness, 95% CI - Zipf opposite missing")
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Missing Attribute to Ideal")
x = [5, 10, 15, 20]
xi = list(range(len(x)))
