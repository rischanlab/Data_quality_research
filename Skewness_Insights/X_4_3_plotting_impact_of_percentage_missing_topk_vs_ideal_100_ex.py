...
output_plot = 'missing_topk_vs_ideal_all_percentage_100_ex'
...
ax.set_ylabel("Effectiveness - Missing on topk columns to Ideal")
...
plt.savefig('plot_100_ex/' + output_plot, format="svg", dpi = 1000)
plt.savefig('plot_100_ex/' + output_plot + '.png')
plt.show()
