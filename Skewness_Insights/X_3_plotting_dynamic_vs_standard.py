...
output_plot = 'dynamic_vs_standard_10'
...
m = 3
#Jaccard
k5j = df[(df['k'] == 5) & (df['percentage'] == percent) & (df['m'] == m)]
k5j = k5j['Jaccard']
k10j = df[(df['k'] == 10) & (df['percentage'] == percent) & (df['m'] == m)]
k10j = k10j['Jaccard']
k15j = df[(df['k'] == 15) & (df['percentage'] == percent) & (df['m'] == m)]
k15j = k15j['Jaccard']
k20j = df[(df['k'] == 20) & (df['percentage'] == percent) & (df['m'] == m)]
k20j = k20j['Jaccard']

#RBO
k5r = df[(df['k'] == 5) & (df['percentage'] == percent) & (df['m'] == m)]
k5r = k5r['RBO']
k10r = df[(df['k'] == 10) & (df['percentage'] == percent) & (df['m'] == m)]
k10r = k10r['RBO']
k15r = df[(df['k'] == 15) & (df['percentage'] == percent) & (df['m'] == m)]
k15r = k15r['RBO']
k20r = df[(df['k'] == 20) & (df['percentage'] == percent) & (df['m'] == m)]
k20r = k20r['RBO']
#
...
ax.set_title("Impact of k on Effectiveness - 95% CI, 10 % missing + impute, m = 3k")
ax.set_xlabel("k")
