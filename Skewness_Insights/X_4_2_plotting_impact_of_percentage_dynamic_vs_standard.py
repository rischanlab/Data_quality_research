...
input_file = 'results/dynamic_vs_standard.csv'

output_plot_ideal_vs_standard = 'dynamic_vs_standard_all_percentage'

# ===============================================================
# IDEAL VS STANDARD

df = pd.read_csv(input_file, names=['percentage','k','m','RBO','Jaccard'])
k = 10
m = 3
#Jaccard

dfj10 = df[(df['k'] == k) & (df['percentage'] == 10) & (df['m'] == m)]
dfj10 = dfj10['Jaccard']

dfj20 = df[(df['k'] == k) & (df['percentage'] == 20) & (df['m'] == m)]
dfj20 = dfj20['Jaccard']

dfj30 = df[(df['k'] == k) & (df['percentage'] == 30) & (df['m'] == m)]
dfj30 = dfj30['Jaccard']

dfj40 = df[(df['k'] == k) & (df['percentage'] == 40) & (df['m'] == m)]
dfj40 = dfj40['Jaccard']

dfj50 = df[(df['k'] == k) & (df['percentage'] == 50) & (df['m'] == m)]
dfj50 = dfj50['Jaccard']

dfj60 = df[(df['k'] == k) & (df['percentage'] == 60) & (df['m'] == m)]
dfj60 = dfj60['Jaccard']

dfj70 = df[(df['k'] == k) & (df['percentage'] == 70) & (df['m'] == m)]
dfj70 = dfj70['Jaccard']

dfj80 = df[(df['k'] == k) & (df['percentage'] == 80) & (df['m'] == m)]
dfj80 = dfj80['Jaccard']

dfj90 = df[(df['k'] == k) & (df['percentage'] == 90) & (df['m'] == m)]
dfj90 = dfj90['Jaccard']
...
#RBO
dfr10 = df[(df['k'] == k) & (df['percentage'] == 10) & (df['m'] == m)]
dfr10 = dfr10['RBO']

dfr20 = df[(df['k'] == k) & (df['percentage'] == 20) & (df['m'] == m)]
dfr20 = dfr20['RBO']

dfr30 = df[(df['k'] == k) & (df['percentage'] == 30) & (df['m'] == m)]
dfr30 = dfr30['RBO']

dfr40 = df[(df['k'] == k) & (df['percentage'] == 40) & (df['m'] == m)]
dfr40 = dfr40['RBO']

dfr50 = df[(df['k'] == k) & (df['percentage'] == 50) & (df['m'] == m)]
dfr50 = dfr50['RBO']

dfr60 = df[(df['k'] == k) & (df['percentage'] == 60) & (df['m'] == m)]
dfr60 = dfr60['RBO']

dfr70 = df[(df['k'] == k) & (df['percentage'] == 70) & (df['m'] == m)]
dfr70 = dfr70['RBO']

dfr80 = df[(df['k'] == k) & (df['percentage'] == 80) & (df['m'] == m)]
dfr80 = dfr80['RBO']

dfr90 = df[(df['k'] == k) & (df['percentage'] == 90) & (df['m'] == m)]
dfr90 = dfr90['RBO']
...
ax.set_title("Impact of percentage of missing on Effectiveness - 95% CI, k = 10, m = 3k")
ax.set_xlabel("percentage of missing")
ax.set_ylabel("Effectiveness - Selective-imputation to Impute-all")
