...
input_file_dynamic_vs_ideal = 'results/dynamic_vs_ideal_10_data_update.csv'
input_file_standard_vs_ideal = 'results/standard_vs_ideal_10_data.csv'


output_plot_standard_dynamic_vs_ideal = 'standard_dynamic_vs_ideal'
...
ax.plot(mean0, lw = 1, color = '#539caf', alpha = 1, label = 'Jaccard Dynamic to Ideal', marker='o', linestyle='dashed', linewidth=2, markersize=12)
ax.plot(mean1, lw = 1, color = '#b65332', alpha = 1, label = 'RBO 0.95 Dynamic to Ideal', marker='s', linestyle=':', linewidth=2, markersize=12)

ax.plot(mean2, lw = 1, color = '#5be19a', alpha = 1, label = 'Jaccard Standard to Ideal', marker='x', linestyle='-.', linewidth=2, markersize=12)
