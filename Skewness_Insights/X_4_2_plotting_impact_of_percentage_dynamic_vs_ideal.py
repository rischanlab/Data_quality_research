...
input_file = 'results/dynamic_vs_ideal.csv'

output_plot_ideal_vs_standard = 'dynamic_vs_ideal_all_percentage'
...
ax.set_ylabel("Effectiveness - Selective-imputation to Ideal")
