...
input_file1 = 'results/ideal_vs_standard.csv'
input_file2 = 'results/ideal_vs_dynamic.csv'

output_plot_ideal_vs_standard = 'ideal_vs_standard_dynamic_all_percentage'
...
ax.plot(mean0, lw = 1, color = '#539caf', alpha = 1, label = 'Jaccard Impute-all to Ideal', marker='o', linestyle='dashed', linewidth=2, markersize=12)
ax.plot(mean1, lw = 1, color = '#b65332', alpha = 1, label = 'RBO 0.95 Impute-all to Ideal', marker='s', linestyle=':', linewidth=2, markersize=12)

ax.plot(mean2, lw = 1, color = '#5be19a', alpha = 1, label = 'Jaccard Selective-imputation to Ideal', marker='x', linestyle='-.', linewidth=2, markersize=12)
ax.plot(mean3, lw = 1, color = '#ece554', alpha = 1, label = 'RBO 0.95 Selective-imputation to Ideal', marker='<', linestyle='-', linewidth=2, markersize=12)
...
ax.set_title("Impact of missing percentage on Effectiveness - 95% CI, k = 5, m = 3k")
